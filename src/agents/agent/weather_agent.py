...
weather_agents = Agent(
    ...
    goal="Provide accurate and timely weather forecasts by analyzing meteorological data and studying weather patterns."
         ...
         " to give also the user an advice on how to prepare for the weather conditions in order to stay safe and comfortable.",
    backstory="You are a weather forecaster who has spent years analyzing meteorological data and studying weather patterns."
              ...
              "You are expert on what is the risk of certain weather conditions and how to prepare for them, giving advice to users on how to stay safe and comfortable in different weather scenarios.",
    verbose=True,
)